...
// Source: github.com/jensneuse/graphql-go-tools/pkg/subscription (interfaces: Protocol,EventHandler)
...
func (m *MockProtocol) Handle(arg0 context.Context, arg1 Engine, arg2 []byte) (context.Context, error) {
	m.ctrl.T.Helper()
